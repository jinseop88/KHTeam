...
public class UILabel : UIWidget
{
    ...
    public enum FontType    // added by soohyoung.lee 폰트가 추가되면 여기에도 추가해줘야 한다.
    {
        LatoBold = 0,
        RixBGoB,
        Furore,
    ...
    [HideInInspector][SerializeField] FontType mFontType = FontType.RixBGoB;// added by soohyoung.lee
    [HideInInspector][SerializeField] public bool bStringTable = false;            // added by waraccc
    ...
    public FontType SelectFontType
    {
        get
        {
            return mFontType;
