...
public class UIWrapContent : MonoBehaviour
{
    ...
    protected Vector3 m_initOffset;
	/// <summary>
	...
	protected virtual void Start ()
	{
        ...
        m_initPos = mScroll.panel.cachedTransform.localPosition;
        m_initOffset = mScroll.panel.clipOffset;
	}
	...
	public virtual void SortBasedOnScrollMovement ()
	{
		...
		for (int i = 0; i < mTrans.childCount; ++i)
		{
            ...
            t.gameObject.SetActive(mChildren.Count < maxIndex);
